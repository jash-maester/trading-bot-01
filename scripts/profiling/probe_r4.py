...
import time, torch
from trader.models.signal import SignalModel, SignalConfig, horizon_key
from trader.data.universe import active_tickers

N = len(active_tickers()); F = 15; L = 60; H = (5, 20)
...
for B in [4, 8, 12, 16, 24, 32]:
    ...
    try:
        ...
        print(f"{B:>6} {'-':>9} {'-':>8} {'OOM':>9}", flush=True); break
